...
import { search, viewAll, viewById, savemakeup, activatemakeup, activemakeupList, removeById, topList, deactivatemakeup } from "../controller/makeup.controller.js";
...
router.post("/deactive", deactivatemakeup);
